// --- Evaluation (Solver Primitive Integration Sprint v2) ------------------
...
// CI, N>=15, adaptive extension) to Baseline vs Candidate, mirroring the
// exact pattern every prior Sprint's own evaluator used. Reuses
