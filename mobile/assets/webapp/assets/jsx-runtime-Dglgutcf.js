...
`)}function Do(e,t){let n;switch(t){case 1:n=`Linear`;break;case 2:n=`Reinhard`;break;case 3:n=`Cineon`;break;case 4:n=`ACESFilmic`;break;case 6:n=`AgX`;break;case 7:n=`Neutral`;break;case 5:n=`Custom`;break;default:console.warn(`THREE.WebGLProgram: Unsupported toneMapping:`,t),n=`Linear`}return`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Oo=new G;function ko(){return W.getLuminanceCoefficients(Oo),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Oo.x.toFixed(4)}, ${Oo.y.toFixed(4)}, ${Oo.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
